...
shared._ASTRIAVERSION = "1.1.6a | "..((shared.astria and "dev" or "release")).." build" -- // This is a cool thing yes
shared._ASTRIAMOTD = "astralia🔥"
print("[astria] Loading!")
repeat wait() until game:IsLoaded()
if shared.Future~=nil then print("[astralia] Detected astralia already executed, not executing!") return end
...
shared.astralia.GuiLibrary = GuiLibrary
...
astria.toggleFriend = function(plrname) 
    if astria.Friends[plrname:lower()] then 
        astria.removeFriend(plrname)
    else
...
if not suc then warn("[astria] Chat hook failed, aborting command system. \n(Error: "..res..")") end
