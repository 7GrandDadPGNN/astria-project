...
makefolder("astralia")
makefolder("astralia/logs")
makefolder("astralia/assets")
makefolder("astralia/configs")
makefolder("astralia/configs/"..tostring(shared.FuturePlaceId or game.PlaceId))
makefolder("astralia/configs/!SelectedConfigs/")
...
GuiLibrary["LoadConfig"] = function(name) 
    ...
    if betterisfile("Future/configs/"..tostring(shared.FuturePlaceId or game.PlaceId).."/"..name..".json") then 
        ...
        if success then 
            ...
            warn("[Future] Failed to load "..tostring(shared.astria Id or game.PlaceId)..".json config file\nplease report this in the discord!\n("..config..")")
        end
    end
